...
export function Header() {
  ...
  return (
    <>
            ...
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex items-center gap-6">
                ...
                <button
                  ...
                  className="text-foreground hover:text-primary transition-colors font-medium cursor-pointer bg-transparent border-0 p-0"
                >
                  Book
                </button>
      ...
      {/* 🌟 Render outside <header> wrapped safely inside Fragment */}
      <BookingModal
        isOpen={bookOpen}
